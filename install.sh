...
echo 'alias archangel="$HOME/core-bridgechain/packages/core/bin/run"' >> ~/.bashrc

rm -rf "$HOME/core-bridgechain"
git clone "https://github.com/xianfeic/Archangel" "$HOME/core-bridgechain" || FAILED="Y"
if [ "$FAILED" == "Y" ]; then
    echo "Failed to fetch core repo with origin 'https://github.com/xianfeic/Archangel'"
...
rm -rf "$HOME/.config/@archangel"
rm -rf "$HOME/.config/@archangel"
rm -rf "$HOME/.config/archangel-core"
